...
In the EU, E160f is an authorized color additive listed in the food additives regulation; permitted use depends on the food category and must follow the conditions set out in Annex II of the law.[^2]
...
In the European Union, E160f is authorized as a food color and must meet strict composition and purity criteria before it can be used.[^1] Authorizations for food additives in the EU are based on a safety evaluation and conditions of use laid down in the food additives regulation.[^2] In the United States, the additive appears on FDA’s Color Additive Status List, which tracks colors permitted for specified uses under federal regulations.[^3]
...
Its purpose is aesthetic—it adds color. E160f is not added for nutrition, flavor, or preservation. In regulatory terms it is a “colour” additive, not a nutrient or supplement, and its use is limited to coloring foods under the applicable rules.[^2]
...
## Myths & facts
- Myth: “E160f is the same as beta‑carotene (vitamin A).”  
...
[^2]: Regulation (EC) No 1333/2008 on food additives (including Annex II on permitted uses). EUR-Lex. https://eur-lex.europa.eu/eli/reg/2008/1333/oj
