...
Food makers use sodium alginate to improve texture and stability. It thickens liquids, helps emulsions (oil‑in‑water mixes) stay mixed, and prevents ice crystals and weeping in frozen and chilled foods. It is the sodium salt of [alginic acid](/e400-alginic-acid){.additive} and is part of the alginate family along with [potassium alginate](/e402-potassium-alginate){.additive}, ammonium alginate (E403), and calcium alginate (E404).  
...
In the EU, E401 is authorised in many food categories under Regulation (EC) No 1333/2008, often at levels “quantum satis,” which means only as much as needed for the effect.[^3] In the U.S., it is GRAS for general food use, following GMP.[^1] You may also see foods that use similar hydrocolloids, such as [carrageenan](/e407-carrageenan){.additive}, [xanthan gum](/e415-xanthan-gum){.additive}, [gellan gum](/e418-gellan-gum){.additive}, [pectins](/e440-pectins){.additive}, [guar gum](/e412-guar-gum){.additive}, or [locust bean gum](/e410-locust-bean-gum){.additive}.

## What can replace sodium alginate?
The best substitute depends on the recipe and processing:
- For general thickening: [xanthan gum](/e415-xanthan-gum){.additive} or [guar gum](/e412-guar-gum){.additive}
- For creamy dairy textures: [locust bean gum](/e410-locust-bean-gum){.additive} or [carrageenan](/e407-carrageenan){.additive}
- For glossy fruit fillings: [pectins](/e440-pectins){.additive} or [gellan gum](/e418-gellan-gum){.additive}  
...
Manufacturers extract alginates from brown seaweeds such as kelp using an alkaline solution, filter and purify the extract, and then convert it to the sodium salt. The material is dried and milled to a powder that meets purity and identity specifications.[^2] In foods, sodium alginate can interact with calcium to set structure; cooks sometimes pair it with calcium salts such as [calcium chloride](/e509-calcium-chloride){.additive} for firm gels.
...
- Myth: It’s the same as [carrageenan](/e407-carrageenan){.additive}.  
