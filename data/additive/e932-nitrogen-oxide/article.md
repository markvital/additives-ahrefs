Nitrogen oxide (E932) refers to nitric oxide, a reactive gas with the chemical formula NO. It is sometimes mentioned alongside food packaging gases, but it is not the same as nitrous oxide (E942) or nitrogen (E941), which are widely used in foods.
...
- Often confused with: [nitrous oxide](/e942-nitrous-oxide){.additive} (E942) and [nitrogen](/e941-nitrogen){.additive}, which are approved gases
...
You should not expect to see E932 on ingredient lists in the EU or U.S. because it is not authorized for food use in those jurisdictions.[^1][^2] Where packaging gases are used, manufacturers rely on approved gases such as [carbon dioxide](/e290-carbon-dioxide){.additive}, [nitrogen](/e941-nitrogen){.additive}, or [nitrous oxide](/e942-nitrous-oxide){.additive} instead.[^2][^3][^6]
...
- [Nitrogen](/e941-nitrogen){.additive} for inerting and cushion gas in snacks and coffee[^2]
- [Carbon dioxide](/e290-carbon-dioxide){.additive} for antimicrobial effect in chilled foods and beverages[^6]
- [Nitrous oxide](/e942-nitrous-oxide){.additive} for whipping cream and foams[^3]
- [Argon](/e938-argon){.additive}, [oxygen](/e948-oxygen){.additive}, or [hydrogen](/e949-hydrogen){.additive} in specific, regulated applications
...
There is no established, approved benefit for nitric oxide as a food additive in the EU or U.S. Approved gases such as [nitrogen](/e941-nitrogen){.additive}, [carbon dioxide](/e290-carbon-dioxide){.additive}, and [nitrous oxide](/e942-nitrous-oxide){.additive} already provide the needed functions (inerting, shelf-life extension, whipping) within current regulations.[^2][^3][^6]
...
- Myth: E932 is just another name for [nitrogen](/e941-nitrogen){.additive}. Fact: Nitrogen is E941; nitric oxide is chemically different (reactive and not approved for food use in EU/U.S.).  
- Myth: E932 is the same as curing nitrite. Fact: Nitrites ([potassium nitrite](/e249-potassium-nitrite){.additive}, [sodium nitrite](/e250-sodium-nitrite){.additive}) are separate additives with different regulations and uses.
