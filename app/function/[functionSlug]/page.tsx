...
const formatCountLabel = (count: number): string =>
  count === 1 ? '1 ingredient offers this benefit.' : `${count} ingredients offer this benefit.`;
...
export async function generateMetadata({ params }: FunctionPageProps): Promise<Metadata> {
  ...
  return {
    title: `${label} skin care ingredients`,
    description: `Browse skin care ingredients that deliver ${functionValue}.`,
    alternates: {
